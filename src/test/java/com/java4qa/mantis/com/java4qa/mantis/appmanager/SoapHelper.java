...
public class SoapHelper {
  ...
  public Set<Project> getProject() throws ServiceException, MalformedURLException, RemoteException {
    ...
    ProjectData[] projects = mc.mc_projects_get_user_accessible(app.getProperty("web.loginAdmin"), app.getProperty("web.loginPassword"));
  ...
  public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
    MantisConnectPortType mc = getMantisConnect();
    String[] categories = mc.mc_project_get_categories(app.getProperty("web.loginAdmin"), app.getProperty("web.loginPassword"),
    ...
    BigInteger issueId = mc.mc_issue_add(app.getProperty("web.loginAdmin"), app.getProperty("web.loginPassword"), issueData);
    IssueData createdIssueData = mc.mc_issue_get(app.getProperty("web.loginAdmin"), app.getProperty("web.loginPassword"), issueId);
